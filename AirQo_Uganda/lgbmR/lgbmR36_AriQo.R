...
library(caret)
set.seed(123)
myFolds <- createFolds(y = dataTrain$target, k = 5, list = TRUE)
index <-list()
...
write.csv(lgbmR36_AirQo, file = "Submission/lgbmR36_AirQo.csv", row.names = FALSE)
